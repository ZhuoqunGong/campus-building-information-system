...
function drawingInfoListChange(){
    ...
    // five <input> tags.
    var bName=document.getElementById("buildingNameInput");
    bName.value=selectedDrawing.BuildingName;

    var yea=document.getElementById("constructedYearInput");
    yea.value=selectedDrawing.ConstructedYear;

    var constructer=document.getElementById("contractorInput");
    constructer.value=selectedDrawing.Contractor;

    var flooor=document.getElementById("floorInput");
    flooor.value=selectedDrawing.Floor;

    var sho=document.getElementById("shopInput");
    sho.value=selectedDrawing.Shop;
...
function addDrawing(){
    ...
    if (newID==null){
        confirm('Please enter the new ID first');
    }
    else {
        var newIdExist=false;
        for( var i=0;i<drawings.length;i++){
        ...
        if(newIdExist){
                confirm('This ID already exists');
        }
        else{
...
function updateDrawing(){
    ...
    var name=document.getElementById("buildingNameInput").value;
    var year=document.getElementById("constructedYearInput").value;
    var constructor=document.getElementById("contractorInput").value;
    var floor=document.getElementById("floorInput").value;
    var shop=document.getElementById("shopInput").value;

    selectedDrawing.BuildingName = name;
    selectedDrawing.ConstructedYear = year;
    selectedDrawing.Contractor = constructor;
    selectedDrawing.Floor = floor;
    selectedDrawing.Shop=shop
